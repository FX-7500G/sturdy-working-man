...
| Проблема | Решение | Ссылка |
| :--- | :--- | :--- |
| Отсутствие удаленного доступа к виртуальной машине через SSH | Смена сетевого интерфейса с NAT на Bridged для получения общего IP, конфигурация статического IP через netplan, настройка UFW | [Решение](./)
</details>
